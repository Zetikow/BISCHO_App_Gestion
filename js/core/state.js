...
const APP_VERSION = "2026-08-03-11"; // À incrémenter à chaque mise à jour déployée
...
let gouter = []; // [[eventId, nom, item], ...] (+ header row) — un item coché par ligne (plusieurs items possibles par personne), Gestion des matchs
